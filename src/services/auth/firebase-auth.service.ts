import { auth, RecaptchaVerifier, signInWithPhoneNumber, PhoneAuthProvider, signInWithCredential } from '@/config/firebase.config';
import { ConfirmationResult } from 'firebase/auth';
import { getDeviceInfo, formatErrorMessage, clearFirebaseAuthCache } from '@/lib/utils/firebase';
