...
export default function PatientsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Smart Mobile-Responsive Header */}
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-healui-physio/20 focus:border-healui-physio transition-all"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <select
                  ...
                  className="px-2 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-healui-physio/20"
                >
                ...
                <div className="flex items-center border border-gray-300 rounded-lg">
                  ...
                  <button
                    ...
                    className={`p-2 rounded-r-lg transition-colors border-l ${
                      viewMode === 'grid' 
                        ? 'bg-healui-physio text-white' 
                        : 'text-gray-400 hover:text-gray-600'
                    }`}
