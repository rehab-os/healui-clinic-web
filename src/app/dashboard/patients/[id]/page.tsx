...
import {
  ...
  CalendarPlus, Eye, Edit, Trash2, Sparkles, Video, IndianRupee
} from 'lucide-react';
...
import PatientBillingPanel from '../../../../components/molecule/PatientBillingPanel';
import {
  SlidePopup,
  SlidePopupContent,
  SlidePopupHeader,
              ...
              {currentClinic?.id ? (
                ...
                <div className="bg-white border-2 border-dashed border-gray-300 rounded-xl p-4">
                  <div className="flex items-center gap-2 text-gray-500">
                    ...
                    <span className="font-medium text-sm">Billing & Packages</span>
                  </div>
                  <p className="text-xs text-gray-400 mt-2">
                    Select a clinic from the header to manage billing and session packages for this patient.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg p-4">
              ...
              <div className="space-y-3">
                {visits.length === 0 ? (
                  ...
                  visits.map((visit) => (
                    <div key={visit.id} className={`rounded-lg p-4 transition-colors ${
                      visit.visit_mode === 'ONLINE' 
                        ? 'border-l-4 border-l-blue-500 bg-gradient-to-r from-blue-50/50 to-gray-50 hover:from-blue-50/70 hover:to-gray-100' 
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          ...
                          {visit.visit_mode === 'ONLINE' && (
                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-blue-500 to-blue-600 text-white border border-blue-600 shadow-sm">
