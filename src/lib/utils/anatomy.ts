...
import headNeckMuscles from '../../data/anatomy/muscles/01_head_and_neck_muscles.json';
import shoulderMuscles from '../../data/anatomy/muscles/02_shoulder_complex.json';
import upperArmMuscles from '../../data/anatomy/muscles/03_upper_arm.json';
import forearmHandMuscles from '../../data/anatomy/muscles/04_forearm_and_hand.json';
import trunkCoreMuscles from '../../data/anatomy/muscles/05_trunk_and_core.json';
import hipPelvisMuscles from '../../data/anatomy/muscles/06_hip_and_pelvis.json';
import thighMuscles from '../../data/anatomy/muscles/07_thigh.json';
import lowerLegMuscles from '../../data/anatomy/muscles/08_lower_leg.json';
import footMuscles from '../../data/anatomy/muscles/09_foot_intrinsic.json';

import jointStructures from '../../data/anatomy/joint_structures.json';
import ligaments from '../../data/anatomy/ligaments.json';
import tendons from '../../data/anatomy/tendons.json';
import neuralStructures from '../../data/anatomy/neural_structure.json';
