import { AssessmentSession, QuestionTemplate } from '@/services/ai/decision-engine.service';
import { OntologyConditionService, ConditionSearchResult } from '@/services/conditions/ontology.service';
