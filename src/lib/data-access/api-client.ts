...
export class ApiMethods {
    ...
    /**
     * Public GET request - no authentication headers
     * Used for public endpoints like QR registration
     */
    static async publicGet(url: string): Promise<ApiResponse> {
        try {
            const response = await fetch(url, {
                method: 'GET',
    ...
    /**
     * Public POST request - no authentication headers
     * Used for public endpoints like QR patient registration
     */
    static async publicPost(url: string, data: any): Promise<ApiResponse> {
        try {
            const response = await fetch(url, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
